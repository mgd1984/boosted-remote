...
BOARD_PATH = KICAD_DIR / "boosted_remote_pcb_outline_review.kicad_pcb"
...
def reroute_right_shoulder(board: pcbnew.BOARD) -> None:
    ...
    sw1_pad1_positions = [(94.241, 85.724), (94.241, 88.174)]
    ...
    route(board, "DEADMAN", [(82.091, 80.449), (92.6, 80.449), (92.6, 85.724), sw1_pad1_positions[0]], layer=pcbnew.B_Cu)
